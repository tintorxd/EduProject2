                  ...
                  <div class="col-md" style="padding-left: 150px; padding-right: 150px">
                    <div class="card mb-4">
                      <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{$administrador->names.' '.$administrador->lastnames}}</h5>
                        <small class="text-muted float-end">Administrador</small>
                      </div>
                      <div class="card-body">
                        <form action="{{ route('registerAdmin.update', ['id'=>$administrador->id]) }}" method="post">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                value="{{$administrador->phone_number}}"
                              />
                            </div>
                          </div>
                                                    
                          <button type="submit" class="btn btn-primary">Actualizar información</button>
                          <a class="btn btn-danger" href="{{ route('registerAdmin.show', ['content'=> "userTable"]) }}" role="button">Cancelar</a>
                        </form>
                      </div>
                    </div>
                  </div>
