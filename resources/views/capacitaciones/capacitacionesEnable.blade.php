...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
            ...
            <div class="" style="max-with: 500px; padding-left: 10px;padding-right: 10px">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Habilitar curso</h5>
                        <small class="text-muted float-end">Capacitacion</small>
                    </div>
                    <div class="card-body">
                        <form id='enable_curso'
                            action="{{ route('registerCurso.enable', ['folder' => 'capacitaciones', 'content' => 'capacitacionesEnableTable', 'tipo' => 'capacitacion']) }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_curso" value="{{ $capacitacion->id }}">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="titulo"
                                        value="{{ $capacitacion->titulo }}" placeholder="Capacitación de Informatica I"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea class="form-control" name="descripcion" placeholder="Breve descripcion del capacitacion"
                                        aria-label="Breve descripcion del capacitacion" aria-describedby="basic-icon-default-fullname2" readonly>{{ $capacitacion->descripcion }}
                              </textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" name="max_personas"
                                        value="{{ $capacitacion->max_personas }}"
                                        aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="duracion"
                                            value="{{ $capacitacion->duracion . ' ' . $capacitacion->unidad_duracion }}"
                            ...
                            <a type="button"
                                href="{{ route('registerCurso.show', ['folder' => 'capacitaciones', 'content' => 'capacitacionesTable', 'tipo' => $capacitacion->tipo_curso]) }}"
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <table id="CapacitacionDocTable" class="table table-striped display" style="width:100%">
                    <thead>
                        <tr>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#CapacitacionDocTable').DataTable({
        ...
        $('#CapacitacionDocTable tbody').on('click', 'tr', function() {
        ...
        $('#fecha_habilitacion').on('change', function() {
            ...
            switch ('{{ $capacitacion->unidad_duracion }}') {
                case 'Días':
