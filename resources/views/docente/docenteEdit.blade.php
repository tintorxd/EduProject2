<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
      <div class="col-md-6">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Docente/</span> Editar Información</h4>
      </div>
                ...
                <div class="col-md" style="padding-left: 150px; padding-right: 150px">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                          <h5 class="mb-0">{{$docente->names.' '.$docente->lastnames}}</h5>
                          <small class="text-muted float-end">Docente</small>
                        </div>
                        <div class="card-body">
                          <form action="{{ route('registerDocente.update', ['id'=>$docente->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <a class="btn btn-danger" href="{{ route('registerDocente.show', ['content'=> "docenteTable"]) }}" role="button">Cancelar</a>
                          </form>
                        </div>
                      </div>
                    </div>
