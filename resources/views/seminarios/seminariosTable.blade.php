...
<div class="container" style="padding: 40px">
    <div class="row">
        <div class="col-md-6">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Seminario/</span> Tabla Seminarios Creados
            </h4>
        </div>
            ...
            <tbody>
                @foreach (session('cursos') as $seminario)
                    <tr>
                        ...
                        <td>{{ $seminario->max_personas }}</td>
                        <td>{{ 'Bs. ' . $seminario->costo }}</td>
                        <td>{{ $seminario->duracion . ' ' . $seminario->unidad_duracion }}</td>
