                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" name="titulo"
                                    placeholder="Seminario de Informatica I" aria-label="Seminario de Informatica I"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <textarea class="form-control" name="descripcion" placeholder="Breve descripcion del seminario"
                                    aria-label="Breve descripcion del seminario" aria-describedby="basic-icon-default-fullname2">
