<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
      <div class="col-md-6">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Seminario/</span> Modificar</h4>
      </div>
                  ...
                  <div class="col-md" style="padding-left: 150px; padding-right: 150px">
                    <div class="card mb-4">
                      <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Curso</h5>
                        <small class="text-muted float-end">Seminario</small>
                      </div>
                      <div class="card-body">
                        <form action="{{ route('registerCurso.update',['id'=> $seminario->id,'tipo'=> $seminario->tipo_curso,'folder'=>'seminarios']) }}" method="post">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            <label class="form-label" for="basic-icon-default-fullname">Descripcion del seminario</label>
                            <div class="input-group input-group-merge">
                              ...
                              <textarea
                                ...
                                placeholder="Breve descripcion del seminario"
                                aria-label="Breve descripcion del seminario"
                                aria-describedby="basic-icon-default-fullname2">{{$seminario->descripcion}}
                              </textarea>
                            </div>
                          </div>
                          <div class="mb-3">
                          ...
                          <a type="button" href="{{ route('registerCurso.show', ['folder'=>'seminarios','content'=> "seminariosTable",'tipo'=> $seminario->tipo_curso]) }}" class="btn btn-secondary">Cancelar</a>
                        </form>
                      </div>
                    </div>
                  </div>
